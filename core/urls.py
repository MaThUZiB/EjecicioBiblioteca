...
urlpatterns = [
    ...
    path('biblioteca/eliminar/<int:id>', eliminar_biblioteca, name = 'eliminar_biblioteca'),
    path('biblioteca/editar/<int:id>', editar_biblioteca, name = 'editar_biblioteca'),
    ...
    path('genero/eliminar/<int:id>', eliminar_genero, name = 'eliminar_genero'),
    path('genero/editar/<int:id>', editar_genero, name = 'editar_genero'),
    ...
    path('ciudad/editar/<int:id>', editar_ciudad, name = 'editar_ciudad'),
